...
window.changePhoto = function (e) {
  ...
  axios.post('api/users/change_photo', imagenFormData).then(function (res) {
    Swal.fire({
...
module.exports = __webpack_require__(/*! /home/alexi/proyectos/laravel/webtres/resources/js/editUser.js */"./resources/js/editUser.js");
